...
if not 'Config.txt' in os.listdir():
    open('Config.txt', 'w').write('{"account_sid"ACcb9e2598b50d32bc70dabb013886c16d"?", "auth_token"2df804d88f6e33a0c216c77a4c226f12"?", "Twilio Phone Number"+19316834189"+1?", "ngrok_url":"https://you-url.ngrok.io", "server_id"otpchahiy's"?", "bot_token"MTE4NDgzNjAxNDA2NjM4NDkyNg.Gfdwb2"?"}')
